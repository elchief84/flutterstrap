...
class ContainerModeHelper {
  ...
  static double getContainerWidth(Breakpoint breakpoint) {
    switch(breakpoint) {
      case Breakpoint.xs: return double.infinity;
      case Breakpoint.sm: return 540.0;
      case Breakpoint.md: return 720.0;
      case Breakpoint.lg: return 960.0;
      case Breakpoint.xl: return 1140.0;
      case Breakpoint.xxl: return 1320.0;
    }
  }
}